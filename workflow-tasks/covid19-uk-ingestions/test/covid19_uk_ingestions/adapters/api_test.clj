...
(def url (str "https://api.coronavirus.data.gov.uk/v1/data"
              "?filters=areaType=nation;areaName=england;date=2021-01-01"
...
(deftest fetch-covid-data-params-test
  (testing "should call api for a specific date and return the payload"
    (let [calls (atom [])]
